...
export default class ExploreModelsProjects extends React.Component{
  ...
  callAPI = (e) => {
    //e.preventDefault();
    console.log("on a prevent");
    findDataByType("/dc/type/pli:city_0?pli:name_i18n.it=Torino");
  }
  ...
  render() {
    return (
      <div>
        ...
        (ex. in <a className="project">geo_1</a> <a className="playground" onClick={this.callAPI} href="/dc/type/pli:city_0?pli:name_i18n.it=Torino" >geo:Area_0</a> )
