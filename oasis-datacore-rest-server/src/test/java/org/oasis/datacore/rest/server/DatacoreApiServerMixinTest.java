...
public class DatacoreApiServerMixinTest {
   ...
   public /*static */void init1setupModels() {
      ...
      DCModel ignCommuneModel = new DCModel("ign.commune"); // rgc., pdp.
      ...
      DCModel ignDepartementModel = new DCModel("ign.departement"); // rgc., pdp.
      ...
      DCModel ignCantonModel = new DCModel("ign.canton"); // rgc.
      ...
      DCModel ignArrondissementModel = new DCModel("ign.arrondissement"); // rgc., bdparcellaire.
      ...
      DCModel ignDivisionModel = new DCModel("ign.division"); // bdparcellaire. ; cadastrale
      ...
      DCModel ignLocalisantModel = new DCModel("ign.localisant"); // bdparcellaire. ; parcellaire
      ...
      DCModel ignParcelleModel = new DCModel("ign.parcelle"); // bdparcellaire.
   ...
   @Test
   public void test() {
      build("alt.tourism.placeKind", "hotel", new HashMap<String,Object>() {{
         put("name", "hotel");
      }});
      DCResource.create(this.containerUrl, "alt.tourism.placeKind", "hotel").set("name", "hotel");
   }
