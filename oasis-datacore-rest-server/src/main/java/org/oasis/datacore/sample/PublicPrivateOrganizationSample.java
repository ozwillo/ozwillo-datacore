...
public class PublicPrivateOrganizationSample extends DatacoreSampleMethodologyBase {
   ...
   public static final String ORGPRI2 = "orgpri2"; // ORG2; /// "orgpri2:Organization_0";
   public static final String ORGPRI2_PROJECT = "samples_orgpri2";
   ...
   public static final String ORGPRI3 = "orgpri3"; // ORG3; /// "orgpri2:Organization_0";
   ...
   public static final String ORG3_SANDBOX_PROJECT = "samples_org3s";
   ...
   public void do2CreateModels(List<DCModelBase> modelsToCreate) {
      ...
      org1Project.addLocalVisibleProject(mainProject); // NO define its visible projects / scopes explicitly... YES ELSE METAMODEL NOT VISIBLE
      ...
      org2Project.addLocalVisibleProject(mainProject); // NO define its visible projects / scopes explicitly... YES ELSE METAMODEL NOT VISIBLE
      ...
      DCModelBase offer2 = new DCModel(AGRILOC_OFFER2, ORG2_PROJECT) // TODO or in orgpri2 project ??
         ...
         //.addField(new DCField("agriloco:maxPrice", "float", true, 100)) // not in actual model
         //.addField(new DCField("agriloco:publishedDate", "date", true, 100)) // for now rather dc:created
         .addField(new DCField("agriloco:answerDeadline", "date", true, 100))
         .addField(new DCField("agriloco:deliveryDeadline", "date", true, 100))
         .addField(new DCResourceField("agriloco:requester", ORG2, true, 100))
         .addField(new DCField("agriloco:state", "string", true, 100)); // required for queries, TODO Q field alias of o:state ? ; "new" or "published", also "accepted" 
      ...
      DCModelBase agrilocorgpri2 = new DCMixin("agrilocorg2:Organization_0", ORGPRI2_PROJECT) // NB. in another project !
         .addField(new DCListField("agrilocorg2:offers", // TODO TODO TODO TODO not visible to cantina !!!!!!!!!!
      ...
      orgpri2Project.addLocalModel(agrilocorgpri2); // else not visible to orgpri2 when adding it
      orgpri2Project.addLocalModel(orgpri2); // NOOOOOOOOOOOOOOOOOOOOOO or at least in orgpri2.Security.requiredProject/Scope
      ...
      org3Project.addLocalVisibleProject(mainProject); // NO define its visible projects / scopes explicitly... YES ELSE METAMODEL NOT VISIBLE
      ...
      DCModelBase offer3 = new DCModel(AGRILOC_OFFER3, ORG3_PROJECT) // TODO or in orgpri2 project ??
         ...
         //.addField(new DCField("agriloco3:maxPrice", "float", true, 100)) // not in actual model
         //.addField(new DCField("agriloco3:publishedDate", "date", true, 100)) // for now rather dc:created
      ...
      DCModelBase agrilocorgpri3 = new DCMixin("agrilocorg3:Organization_0", ORG3_PROJECT) // in same project !
         .addField(new DCListField("agrilocorg3:offers", // TODO TODO TODO TODO not visible to cantina !!!!!!!!!!
               new DCResourceField("useless", offer2.getName(), true, 100), true));
      ...
      DCModelBase orgpri3 = new DCModel(ORGPRI3, ORG3_PROJECT) // in same project
         ...
         .addField(new DCField("orgpri3:state", "string", true, 100)) // required for queries, TODO Q field alias of o:state ? ; "published" or "modified" (or "new", "deleted" ??)
         // orgpri specific business fields :
   ...
   private void doInitSampleDataOrg2() throws Exception {
      ...
      postDataInTypeIfNotExists(DCResource.create(owPriUri)
            ...
            .set("orgpri2:publishedVersion", 0) // i.e. owPri's !!!
            .set("orgpri2:state", "published")
            .set("orgpri2:employeeNb", 130), ORGPRI2_PROJECT);
      ...
      postDataInTypeIfNotExists(DCResource.create(md2Uri)
            .set("odisp:name", "M D")
      ...
      owPri.set("agrilocorg:proposedOffers", DCResource.listBuilder().add(webAppOfferUri).build());
      postDataInTypeIfNotExists(owPri , ORGPRI2_PROJECT);
   }
